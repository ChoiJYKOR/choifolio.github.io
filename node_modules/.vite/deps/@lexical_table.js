...
var TableExtension = defineExtension({
  ...
  register(editor, config, state) {
    ...
    }), registerTablePlugin(editor), E(() => registerTableSelectionObserver(editor, stores.hasTabHandler.value)), E(() => stores.hasCellMerge.value ? void 0 : registerTableCellUnmergeTransform(editor)), E(() => stores.hasCellBackgroundColor.value ? void 0 : editor.registerNodeTransform(TableCellNode, (node) => {
